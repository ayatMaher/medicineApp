...
import com.example.medicineapplication.databinding.ActivityCommonQuationsPageBinding
...
class CommonQuationsPage : AppCompatActivity() {
    private lateinit var binding: ActivityCommonQuationsPageBinding
    private lateinit var recyclerView: RecyclerView
    private lateinit var faqAdapter: QuationsAdapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding=ActivityCommonQuationsPageBinding.inflate(layoutInflater)
